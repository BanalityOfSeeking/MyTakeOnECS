...
namespace BonesOfTheFallen.Services
{
    ...
    /// </summary>
    public sealed class EntitySafeSparseSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitySafeSparseSet"/> class.
        /// </summary>
        /// <param name="maxValue">The maximal value the set can contain.</param>
        public EntitySafeSparseSet(int maxValue)
        {
            _max = maxValue + 1;
            _n = 0;
            _d = new int[_max];
        ...
        public void AddEntity(EntitySafe entity)
        {
        ...
        public void AddComponent<Component>(ref  EntitySafe entity, Component component) where Component : struct, IComponentBase
        {
            if (Contains(entity))
            {
        ...
        /// </summary>
        /// <param name="entity">The value.</param>
        public void RemoveEntity(EntitySafe entity)
        {
            if (Contains(entity))
            {
        ...
        public void RemoveComponent<Component>(EntitySafe entity)
        {
